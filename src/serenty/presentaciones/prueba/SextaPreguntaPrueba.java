 ...
 * @author Valeria
 */
public class SextaPreguntaPrueba extends javax.swing.JFrame {
    private Contador contador;
    /**
     * Creates new form sexto
     */
    public SextaPreguntaPrueba() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Has sentido tensión muscular, sudoración o mareos en ");

        jLabel2.setFont(new java.awt.Font("COCOGOOSE ", 0, 14)); // NOI18N
        jLabel2.setText(" los últimos días?");
    ...
    private void siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteActionPerformed
        ...
        SeptimaPreguntaPrueba septimaPreguntaPrueba = new SeptimaPreguntaPrueba();
        septimaPreguntaPrueba.setVisible(true);
...
//            java.util.logging.Logger.getLogger(SextaPregunta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new SextaPregunta().setVisible(true);
//            }
//        });
//    }

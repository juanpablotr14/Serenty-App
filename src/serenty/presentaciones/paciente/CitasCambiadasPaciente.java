 ...
 * @author User
 */
public class CitasCambiadasPaciente extends javax.swing.JInternalFrame {
    ...
    public void MostrarCitas (){
        ...
        try {
            ...
            PreparedStatement psConsultaPaciente = (PreparedStatement) cn.prepareStatement(String.format(ConsultasDB.SELECT_IDPACIENTE_IDUSUARIO, String.valueOf(idUsuario.getIdUsuario())));
            ...
            PreparedStatement psCitas = (PreparedStatement) cn.prepareStatement(String.format(ConsultasDB.SELECT_CITA_IDPACIENTE_DOS, idPaciente));
            ResultSet rsCitas = psCitas.executeQuery();

            while(rsCitas.next()){
                
                datos[0] = rsCitas.getString("ID_CITA");
                datos[1] = rsCitas.getString("NOMBRE_PSICOLOGO");
                datos[2] = rsCitas.getString("FECHA_CITA");
                datos[3] = rsCitas.getString("HORA_CITA");
                datos[4] = rsCitas.getString("MODALIDAD_CITA");
                datos[5] = rsCitas.getString("DIRECCION_CITA");
                datos[6] = rsCitas.getString("DESCRIPCION_CITA");
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Citas Reagendadas o Canceladas");
